...
PENTEST_SUBS["Recon"]="nmap masscan amass subfinder theharvester recon-ng spiderfoot sherlock dnsrecon enum4linux fierce dnsenum nbtscan onesixtyone shodan censys httpx naabu dnsx puredns chaos github-subdomains shuffledns findomain knock sublist3r osmedeus anubis dnsprobe massdns dnsvalidator cloudenum awscli gcloud azure-cli cloud_enum bucket_finder s3scanner lazys3 dnsgen altdns"
PENTEST_SUBS["Web"]="sqlmap nosqlmap sqlninja bbqsql jsql-injection sqliv sqlsus ffuf gobuster wfuzz dirsearch dirb nikto whatweb wpscan joomscan droopescan cmsmap commix dalfox xsstrike xsser xss-payload arjun parameth waybackurls gau nuclei subjack katana feroxbuster corsy cdncheck hakrawler cariddi filter-resolved gowitness aquatone eyewitness httprobe smuggler kiterunner graphql-cop graphql-voyager jwt-tool jwt-cracker jwt-hack ssti-payload ssti-scanner lfi-finder rfi-finder open-redirect ssrf-finder crlf-injector h2c-smuggler cache-poison cache-vuln xxe-injector xxe-scanner deserialization-scanner"
PENTEST_SUBS["Exploit"]="metasploit exploitdb evil-winrm bloodhound bloodhound-python crackmapexec shellter routersploit aclpwn msfvenom searchsploit setoolkit impacket responder smbclient rpcclient pwnkit linux-exploit-suggester windows-exploit-suggester local-exploit exploit-db msfpc mimi mimikatz keimpx pth-toolkit psexec wmiexec atexec dcomexec smbexec goldeneye slowloris hping3 fuxploider lse beef cobaltstrike empire merlin"
PENTEST_SUBS["Network"]="wireshark-qt tcpdump ettercap mitm6 dsniff macchanger arp-scan netdiscover nping ngrep tshark tcpflow mitmproxy hping3 socat zmap scapy nemesis packETH traceroute mtr bmon iptraf-ng vnstat iftop nethogs iperf3 mausezahn tcpreplay tcprewrite"
PENTEST_SUBS["Credential"]="hashcat john hydra crunch cewl hashid hashcat-utils kwprocessor maskprocessor rsmangler mimikatz laZagne hash-identifier rubeus kerbrute bloodhound-python Certipy adidnsdump pywerview impacket evil-winrm crackmapexec pth-toolkit responder smbclient"
PENTEST_SUBS["Social"]="bettercap gophish hiddeneye wifiphisher blackeye fluxion seeker social-analyzer ghost-phisher evilginx2 king-phisher modlishka credential-phisher beef socialfish"
PENTEST_SUBS["C2"]="proxychains-ng tor openvpn wireguard-tools chisel ligolo-ng sliver bore stunnel autossh ncat frp ngrok pivotnacci socks5 termite venom merlin cobaltstrike empire"
PENTEST_SUBS["Wireless"]="aircrack-ng airgeddon wifite mdk3 hcxtools hcxdumptool reaver kismet bully pixiewps hostapd dnsmasq eaphammer mdk4 bettercap wifi-honey fluxion wifipumpkin airmon-ng airodump-ng"
PENTEST_SUBS["Privesc"]="linux-exploit-suggester watson pspy beroot linenum certipy peass gtfo suid3num lse linuxprivchecker unix-privesc-check windows-privesc-check powerup beRoot linpeas winpeas pwnkit polkit-exploit SUID3NUM"
PENTEST_SUBS["OSINT"]="maigret holehe phoneinfoga whatbreach trape tinfoleak photon metagoofil ghunt osintgram perl-image-exiftool theharvester recon-ng sherlock twint instagram-scraper facebook-osint linkedin-analyzer github-osint email-osint username-search geolocation-tools shodan-cli censys-cli virustotal-cli"
PENTEST_SUBS["Serialization"]="phpggc ruby-serialize ysoserial burp zap ffuf wfuzz hash-analyzer crypto-tools binary-exploitation"
